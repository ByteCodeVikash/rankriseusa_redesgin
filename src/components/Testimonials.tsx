  ...
  const testimonials = [
    {
      ...
      content: 'Rankrise completely revolutionized our digital presence. Their GEO strategy didn\'t just bring traffic; it positioned us as the primary authority on ChatGPT and Gemini. A masterclass in modern marketing.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The custom AI agents Rankrise built for our operations saved us thousands of man-hours. It\'s rare to find an agency that truly understands LLM architecture and business ROI simultaneously.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Moving to a headless architecture with Rankrise was the best decision for our brand. Our site speed is now world-class, and our mobile conversion has skyrocketed by 3x.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'From the initial brand concept to the final high-performance deployment, Rankrise delivered excellence at every step. They are the only choice for founders who want to win.',
      rating: 5,
