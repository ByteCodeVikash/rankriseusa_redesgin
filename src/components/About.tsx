      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center mb-32">
          ...
          >
            ...
            <h2 className="text-6xl sm:text-8xl font-black text-black leading-[0.85] tracking-tighter uppercase">
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <Button className="button-premium px-12 py-9 text-sm uppercase tracking-[0.2em] h-auto rounded-2xl">
                Our Methodology
              </Button>
              <Button variant="outline" className="px-12 py-9 text-sm uppercase tracking-[0.2em] h-auto rounded-2xl border-gray-200 text-black hover:bg-gray-50 transition-all font-black">
                Consultancy Intel
              </Button>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-gray-50 p-12 rounded-[3rem] border border-gray-100 hover:border-primary/30 transition-all duration-700 group relative overflow-hidden shadow-sm"
              >
                ...
                <div className="text-5xl font-black text-black mb-3 tracking-tighter relative z-10">
        ...
        <div className="pt-24 border-t border-gray-100">
          ...
          >
            <h3 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter text-black uppercase">Technical <span className="text-primary italic">Sovereignty.</span></h3>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="mb-10 relative inline-block">
                  ...
                  <div className={`relative w-24 h-24 rounded-[2.5rem] bg-gray-50 border border-gray-100 flex items-center justify-center group-hover:border-primary/30 transition-all duration-700 group-hover:-translate-y-2 group-hover:bg-white group-hover:shadow-xl`}>
